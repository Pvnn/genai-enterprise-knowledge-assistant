...
async def ingest_document(
    ...
    try:
        ...
        await session.execute(
            ...
            .values(ingestion_status=IngestionStatus.PROCESSING.value)
        )
        ...
        # We pass effective_date and version_status as None and "current" as default.
        # If the orchestrator API fetches them from the DB first, it would pass them here.
